...
// Dois endpoints no mesmo arquivo de propósito: o plano Hobby da Vercel permite
// 12 funções serverless por deploy. Não separe de volta sem conferir a contagem
// de arquivos em api/*.mjs.
//   GET /api/me          → dados do usuário do token
//   GET /api/me?r=meses  → meses que têm programa ativo
